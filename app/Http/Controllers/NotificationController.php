...
class NotificationController extends Controller
{
    ...
    public function sendAutoFestivalNotification(Request $request)
    {
        if (Setting::getValue('auto_festival_notification') == 'true') {
            ...
            foreach ($festivals as $festival) {
                ...
                $headers = ['Authorization:key=' . Setting::getValue('fcm_key'), 'Content-Type:application/json'];
    ...
    public function store(Request $request)
    {
        ...
        $headers = ['Accept: application/json', 'Authorization: Basic ' . Setting::getValue('onesignal_key'), 'Content-Type: application/json'];
