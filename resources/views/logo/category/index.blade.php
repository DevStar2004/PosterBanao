                ...
                <div class="card-header py-0 bg-primary">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto mt-3">
                            <a href="{{ route('logocategory.create') }}" class="btn btn-success {{$is_permitted ? "" : "disabled"}}">
                                                ...
                                                <td class="align-middle">
                                                    <div class="ms-auto text-end align-middle text-center text-sm">
                                                        ...
                                                        <a class="btn btn-icon-only btn-rounded btn-success"
                                                            href="{{ secure_url('/logocategory/' . $category->id . '/edit') }}"><i
                                                                class="fas fa-pencil-alt"></i></a>
                                                    </div>
                                                </td>
                                            </tr>

                                            <form action="{{ url('logocategory/' . $category->id) }}" method="POST"
                                                id="form-{{ $category->id }}">
                                                @method('DELETE')
                                                @csrf
