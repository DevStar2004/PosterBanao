                        ...
                        <div class="row mb">
                            @foreach ($logos as $sticker)
                                <div class="col-xl-2 col-l-3 col-sm-4 p-2  bg-transparent">
                                    ...
                                    <div style="background:gray;background-image: url(@if ($sticker->thumb_url) {{ url($sticker->thumb_url) }} @else {{ url('/images/placeholder.jpg') }} @endif);height:140px;background-size: cover;"
                                        ...
                                        <div class="card-body position-relative z-index-1 p-2">
                                            ...
                                            <div class="mt-5">
                                                ...
                                                <div class="d-flex mt-1">
                                                    <div>
                                                        <a class="btn btn-icon-only btn-rounded btn-success mb-0 me-2 btn-sm d-flex align-items-center justify-content-center"
                                                            href="{{ secure_url('/logos/' . $sticker->id . '/edit') }}">
                                                ...
                                                <form action="{{ url('logos/' . $sticker->id) }}" method="POST"
                                                    id="form-{{ $sticker->id }}">
                                                    @method('DELETE')
                                                    @csrf
