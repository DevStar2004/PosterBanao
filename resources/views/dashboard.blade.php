...
@php
    $is_permitted = App\Models\Admin::isPermission('admin');
@endphp
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        <h5 class="font-weight-bolder text-xlg count-up text-white"
                                ...
                                <div class="col-4 text-end">
                                    <div
                                        class="icon icon-shape bg-gradient-faded-white-vertical  shadow-primary text-center rounded-circle">
                            ...
                            <div class="row gx-2">
                                <div class="col-auto">
                                    <div class="avatar avatar-xl position-relative" style="background-color: #31acd1;">
                                        <img src="https://res.cloudinary.com/ddq12bxae/image/upload/v1674566369/dailyposte/wallet_1_iph0bi.png"
                                            alt="profile_image" class="w-50 shadow-sm">
                                    </div>
                                </div>
                            ...
                            <div class="row gx-2">
                                <div class="col-auto">
                                    <div style="background-color: #cf3e27;" class="avatar avatar-xl position-relative">
                                        <img src="https://res.cloudinary.com/ddq12bxae/image/upload/v1674566473/dailyposte/7-days_1_m6nwp6.png"
                                            alt="profile_image" class="w-50 shadow-sm">
                                    </div>
                                </div>
                                <div class="col-auto my-auto">
                            ...
                            <div class="row gx-2">
                                <div class="col-auto">
                                    <div class="avatar avatar-xl position-relative" style="background-color: #482aa5;">
                                        <img src="https://res.cloudinary.com/ddq12bxae/image/upload/v1674566753/dailyposte/thirty-one_knu5ol.png"
                                            alt="profile_image" class="w-50 shadow-sm">
                                    </div>
                                </div>
                                <div class="col-auto my-auto">
                                    <div class="h-100">
                                        ...
                                        <p class="mb-0 font-weight-bold text-lg">
                                            {{ App\Models\Setting::getValue('currency') }} {{ $monthly_payment }} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row gx-2">
                                <div class="col-auto">
                                    <div class="avatar avatar-xl position-relative" style="background-color: #db0098;">
                                        ...
                                        <img src="https://res.cloudinary.com/ddq12bxae/image/upload/v1674566910/dailyposte/365_1_jd3dmo.png"
                                            alt="profile_image" class="w-50 shadow-sm">
                                    </div>
                                </div>
                                <div class="col-auto my-auto">
                                    <div class="h-100">
                                        ...
                                        <p class="mb-0 font-weight-bold text-lg">
                                            {{ App\Models\Setting::getValue('currency') }} {{ $total_payment }} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body p-3">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <div>
                                                        <p
                                                            class="text-xs mb-0 text-uppercase ps-1 text-dark font-weight-bolder">
                                                            {{ $event->name }}</p>
                                                        <div class="row mt-2">
                                                            <div class="col">
                                                                <div class="d-flex ">
                                                                    <div class="d-grid text-center mx-3">
                                                                        <span
                                                                            class="text-lg font-weight-bolder text-dark">{{ $event->posts }}</span>
                                                                        <span
                                                                            class="text-sm opacity-8 text-dark">Posts</span>
                                                                    </div>
                                                                    <div class="d-grid text-center">
                                                                        <span
                                                                            class="text-lg font-weight-bolder text-dark">{{ $event->video }}</span>
                                                                        <span
                                                                            class="text-sm opacity-8 text-dark">Videos</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <li
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <span class="text-xs">End on <span
                                                    class="font-weight-bold">{{ date('d M, y', strtotime($user->subscription_end_date)) }}</span></span>
                                        </div>
                                    </div>
                                    <div class="d-flex ">
                                        <a href="{{ url('users/' . $user->id) }}"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <a href="{{ url('users/' . $trasaction->user->id) }}">
                                                            <h6 class="mb-0 text-sm">{{ $trasaction->user->name }}</h6>
                                                        </a>
                                                        <p class="text-xs text-secondary mb-0">
                                                            @if ($trasaction->user->email)
                                                                {{ $trasaction->user->email }}
                                                            @else
                                                                {{ $trasaction->user->number }}
                                                            @endif
                                                        </p>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            ...
                                            <div class="icon-shape avatar rounded-circle"
                                                style="background-image: url(@if ($contacts->user->profile_pic) {{ asset($contacts->user->profile_pic) }} @else {{ url('/images/placeholder.jpg') }} @endif);background-size: cover;">
                                            </div>
                                        </div>

                                        <div class="flex-grow-1 ms-3">
                                            <a href="{{ url('users/' . $contacts->user->id) }}">
                                                <h6 class="h6 mt-0">{{ $contacts->user->name }}</h6>
                                            </a>
