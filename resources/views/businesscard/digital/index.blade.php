    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-header py-0 bg-primary">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto mt-3">
                            <a href="{{ route('businesscarddigital.create') }}" class="btn btn-success {{$is_permitted ? "" : "disabled"}}">
                                    ...
                                    <div style="border-radius: 14px;">
                                        <div style="background-image: linear-gradient(transparent, transparent, transparent, transparent, transparent, #302d2d, black);border-radius: 17px;"
                                            ...
                                            <div class="mt-9">
                                                ...
                                                <form action="{{ url('businesscarddigital/' . $post->id) }}" method="POST"
                                                    id="form-{{ $post->id }}">
                                                    @method('DELETE')
                                                    @csrf
                ...
                @else <span> You are not allowed on this page </span>
                @endif
            </div>
        </div>
    </div>
