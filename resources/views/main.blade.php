    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 fixed-start " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="/" target="_blank">
                <img src="{{ asset(App\Models\Setting::getValue('app_logo')) }}"
                    class="avatar avatar-sm navbar-brand-img h-100" alt="main_logo">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#festivalSection"
                        ...
                        aria-controls="festivalSection" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#businessSection"
                        class="nav-link {{ Request::path() == 'businessCategory' || Request::path() == 'businessSubCategory' || Request::path() == 'business' ? 'active' : '' }}"
                        aria-controls="businessSection" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#politicalSection"
                        class="nav-link {{ Request::path() == 'politicalCategory' || Request::path() == 'political' ? 'active' : '' }}"
                        aria-controls="politicalSection" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#customSection"
                        ...
                        aria-controls="customSection" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                @if (App\Models\Admin::isPermission('greeting'))
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#greetingExamples"
                            ...
                            aria-controls="greetingExamples" role="button" aria-expanded="false">
                            <div
                                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <div class="collapse {{ Request::path() == 'greeting' || Request::path() == 'greetingsection' ? 'show' : '' }}"
                            id="greetingExamples">
                            <ul class="nav ms-4">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#stickerExamples"
                        class="nav-link {{ Request::path() == 'sticker' || Request::path() == 'stickercategory' || str_contains(Request::path(), 'stickerCategory') ? 'active' : '' }}"
                        aria-controls="stickerExamples" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                @if (App\Models\Admin::isPermission('frame'))
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#frameExamples"
                            ...
                            aria-controls="frameExamples" role="button" aria-expanded="false">
                            <div
                                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <div class="collapse {{ Request::path() == 'frame' || Request::path() == 'framecategory' || str_contains(Request::path(), 'frameCategory') ? 'show' : '' }}"
                            id="frameExamples">
                            <ul class="nav ms-4">
                                <li
                                    class="nav-item {{ Request::path() == 'frame' || str_contains(Request::path(), 'frameCategory') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#logoExamples"
                            class="nav-link {{ Request::path() == 'logos' || Request::path() == 'logocategory' || str_contains(Request::path(), 'logocategory') ? 'active' : '' }}"
                            aria-controls="logoExamples" role="button" aria-expanded="false">
                            <div
                                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="fa fa-square text-primary text-sm opacity-10"></i>
                            </div>
                        ...
                        <div class="collapse {{ Request::path() == 'logos' || Request::path() == 'logocategory' || str_contains(Request::path(), 'logocategory') ? 'show' : '' }}"
                            id="logoExamples">
                            <ul class="nav ms-4">
                ...
                @if (App\Models\Admin::isPermission('admin'))
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::path() == 'admins' ? 'active' : '' }}"
                            href="{{ url('admins') }}">
                            <div
                                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative">
        <nav class="navbar navbar-main shadow-none" id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3 bg">
                ...
                <a href="{{ url('admins/' . Session::get('userid')) . '/edit' }}"><img
                        src="{{ url(Session::get('profile')) }}" class="avatar avatar-sm "></a>
