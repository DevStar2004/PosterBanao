...
@php
    $is_permitted = App\Models\Admin::isPermission('video');
@endphp
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                @if ($is_permitted == true)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex py-1">
                                                        <div>
                                                            <img src="@if ($music->thumbnail) {{ url($music->thumbnail) }} @else {{ url('/images/placeholder.jpg') }} @endif"
                                                ...
                                                <td class="align-middle text-center">
                                                    <a class="btn btn-icon-only btn-rounded btn btn-warning"
                                                        href="{{ url($music->item_url) }}">
                                                        <i class="fas fa-play">
                                                        </i>
                                                    </a>
                                                </td>
                                                ...
                                                <td class="align-middle text-center">
                                                    <div onclick="cheakPremium({{ $music->id }})"
                                                ...
                                                <td class="align-middle text-center">
                                                    <div class="form-switch align-items-center justify-content-center">
                                                        <input class="form-check-input status-switch" type="checkbox"
                                                            data-id="{{ $music->id }}"
                                                            @if ($music->status == 0) checked @endif>
                                                    </div>
                                                </td>

                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ date('d M, y', strtotime($music->created_at)) }}</span>
                                                </td>

                                                <td class="align-middle">
                                                    <div class="ms-auto text-end align-middle text-center text-sm">
                                                        <a href="#" data-id="{{ $music->id }}" data-toggle="modal"
                                                            data-target="#deleteModal"
                                                            class="btn btn-icon-only btn-rounded btn-danger"><i
                                                                class="far fa-trash-alt"></i></a>

                                                        <a class="btn btn-icon-only btn-rounded btn btn-success"
                                                            href="{{ secure_url('/music/' . $music->id . '/edit') }}"><i
                    ...
                    @endif
                @else
                    <span> Sorry!, You are not alllowed on this page </span>
                @endif
            </div>
        </div>
    </div>
