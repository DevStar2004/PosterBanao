                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action=" {{ route('festival.store') }} " id="addform"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Name <b
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Select Festival <b
                                                    style="color:red">{{ $errors->first('category') }}</b></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Select Premium <b
                                                    style="color:red">{{ $errors->first('premium') }}</b></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Select Language <b
                                                    style="color:red">{{ $errors->first('language') }}</b></label>
                                    ...
                                    <input type="hidden" name="removed_files" class="removed_files" id="removed_files"
                                        value="[]">
        ...
        function imagePreview(fileInput) {
            ...
            for (var i = 0; i < total_file; i++) {
                $('#previewImages').append(
                    ...
                    "' id='imge' class='border-radius-md' alt='team-2'>" +
                    "<a id='" + i +
                    "' class='remove_img btn btn-sm btn-icon-only bg-gradient-danger position-absolute end-0 mb-n2 me-n2'>" +
