...
@php
    $is_permitted = App\Models\Admin::isPermission('subscription');
@endphp
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-header py-0 bg-primary">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto mt-3">
                            <a href="{{ route('subscription.create') }}" class="btn btn-success {{$is_permitted ? "" : "disabled"}}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex py-1">
                                                    <div>
                                                        <img src="@if ($subscription->image) {{ url($subscription->image) }} @else {{ url('/images/placeholder.jpg') }} @endif"
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        ...
                                                        <p class="mb-0 text-sm">{{ $subscription->value }}
                                                            {{ $subscription->type }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0">
                                                    {{ App\Models\Setting::getValue('currency') }}
                                                    {{ $subscription->discount_price }}</p>
                                            </td>

                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0">+{{ $subscription->posts_limit }}
                                                </p>
                                            </td>

                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0">
                                                    {{ $subscription->business_limit }}</p>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <div class="form-switch align-items-center justify-content-center">
                                                    <input class="form-check-input status-switch" type="checkbox"
                                                        ...
                                                        @if ($subscription->status == 0) checked @endif>
                                                </div>
                                            </td>

                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{ date('d M, y', strtotime($subscription->created_at)) }}</span>
                                            </td>


                                            <td class="align-middle">
                                                <div class="ms-auto text-end align-middle text-center text-sm">
                                                    <a href="#" data-id="{{ $subscription->id }}" data-toggle="modal"
                                                        data-target="#deleteModal"
                                                        class="btn btn-icon-only btn-rounded btn-danger"><i
                                                            class="far fa-trash-alt"></i></a>
                                                    <a class="btn btn-icon-only btn-rounded btn btn-success"
                                                        href="{{ secure_url('/subscription/' . $subscription->id . '/edit') }}"><i
                ...
                @else <span> Sorry, You are not allowed on this page <span>
                @endif
            </div>
        </div>
    </div>
