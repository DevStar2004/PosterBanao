...
@php
    $is_permitted = App\Models\Admin::isPermission('contacts');
@endphp
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex py-1">
                                                    <div>
                                                        <img src="@if ($contact->user->profile_pic) {{ url($contact->user->profile_pic) }} @else {{ url('/images/placeholder.jpg') }} @endif"
