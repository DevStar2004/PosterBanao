...
@php
    $is_permitted = App\Models\Admin::isPermission('offerdialog');
@endphp
                ...
                <div class="card-header py-0 bg-primary">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto mt-3">
                            <a href="{{ route('offerdialog.create') }}"
                        ...
                        <div class="row mb">
                            @foreach ($offerdialogs as $offerdialog)
                                <div class="col-xl-3 col-l-6 col-sm-4 p-2  bg-transparent">
                                    ...
                                    <div style="background-image: url(@if ($offerdialog->item_url) {{ url($offerdialog->item_url) }} @else {{ url('/images/placeholder.jpg') }} @endif);height:240px;background-size: cover;"
                                                ...
                                                <div class="d-flex mt-3">
                                                    <div>
                                                        <a class="btn btn-icon-only btn-rounded btn-success mb-0 me-2 btn-sm d-flex align-items-center justify-content-center"
                                                            href="{{ secure_url('/offerdialog/' . $offerdialog->id . '/edit') }}">
                                                    ...
                                                    <div>
                                                        <button
                                                            ...
                                                            data-id="{{ $offerdialog->id }}" data-toggle="modal"
                                                    ...
                                                    <div class="form-switch align-items-center justify-content-center">
                                                        <input class="form-check-input status-switch" type="checkbox"
                                                            data-id="{{ $offerdialog->id }}"
                                                            @if ($offerdialog->status == 0) checked @endif>
                                                    </div>

                                                </div>

                                                <form action="{{ url('offerdialog/' . $offerdialog->id) }}" method="POST"
                                                    id="form-{{ $offerdialog->id }}">
                                                    @method('DELETE')
                                                    @csrf
